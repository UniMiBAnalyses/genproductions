...
make_gridpack () {
    ...
    #           echo "set cluster_temp_path `echo $RUNHOME`" >> mgconfigscript 
      ...
      cp /afs/cern.ch/work/g/gboldrin/public/public/genproductions_unimib/bin/MadGraph5_aMCatNLO/cards/WV_semileptonic_01J_propHack/restrict_cll1_cG_cHd_cHDD_cHj3_cjj38_cHWtil_cHj1_cju1_cuu8_cdd8_cuu1_cdd1_cHG_cHe_cHl1_cHWB_cHl3_cju8_cjd1_clu_cWtil_clj3_cjj11_cHu_ceu_cHWBtil_ced_clj1_cjj18_cGtil_cW_cld_cje_cjd8_cud8_cud1_cjj31_cHGtil_massless.dat SMEFTsim_topU3l_MwScheme_propagatorhack_UFO_b_massless
      cd .. 
	    ...
	    echo "IL CAZZO DI MODELLO"
  	    echo $model
            if [[ $model == *".zip"* ]]; then
              ...
              tar zxvf ../$model
	      echo "COPIO"
              cp /afs/cern.ch/work/g/gboldrin/public/public/genproductions_unimib/bin/MadGraph5_aMCatNLO/cards/WZ_semileptonic_01J_EWDIM6/restrict_no_cmass_cwwwcbcw.dat EWdim6NLO
            elif [[ $model == *".tar"* ]]; then
	      echo "TAR XAVF"
              tar xavf ../$model
              echo "COPIO"
    ...
    # # # # # # # # # # # #
    # HERE STARTS THE INTEGRATE STEP
    # # # # # # # # # # # #
